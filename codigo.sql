/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     05/01/2024 02:02:10                          */
/*==============================================================*/
...
alter table verificaçao_venda add constraint FK_Verificacao_Docente foreign key (ID_docente)
      references Docente (ID_docente) on delete restrict on update restrict;

alter table verificaçao_venda add constraint FK_Verificacao_Estudante foreign key (ID_Estudantes)
      references Estudantes (ID_Estudantes) on delete restrict on update restrict;
